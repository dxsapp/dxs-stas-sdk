...
| delivery-backend-contracts   | backend     | BE-Contracts      | done        | -                          | Codex            | Protocol/parser/security invariants sit here                       |
| delivery-backend-platform    | backend     | BE-Platform       | done        | delivery-backend-contracts | Codex            | Assembly/planning depends on protocol guardrails                   |
| delivery-backend-reliability | backend     | BE-Reliability    | done        | delivery-backend-contracts | Codex            | Negative corpus and malformed coverage depend on parser decisions  |
| delivery-integration         | integration | -                 | done        | delivery-backend-platform  | Codex-Spark      | Packaging/integration smoke should run on stabilized assembly path |
